...
//        LessonStatus route = LessonStatus.COMPETITION_PREP;
//
...
//
//        LessonResponseForAdmin expectedResponse = new LessonResponseForAdmin(lessonID, horseID, instructorID, route);
//
...
//
//        LessonResponseForAdmin actual = service.getLessonById(lessonID);
//
...
//        Long instructorID = instructor.getId();
//
//        LessonResponseForAdmin lessonsResponse1 = new LessonResponseForAdmin(id1, horseID, instructorID, route);
//        LessonResponseForAdmin lessonsResponse2 = new LessonResponseForAdmin(id2, horseID, instructorID, route);
//
...
//
//        List<LessonResponseForAdmin> result = service.getAllLessons();
//
...
//        Lesson lesson = new Lesson(lessonID, horse, instructor, route);
//
//        LessonResponseForAdmin response = new LessonResponseForAdmin(lessonID, horseID, instructorID, route);
//
...
//
//        LessonResponseForAdmin result = service.createLesson(request);
//
...
//        LessonStatus detailsRoute = LessonStatus.COMPETITION_PREP;
//
...
//        Lesson lesson = new Lesson(lessonID, horse, instructor, route);
//
//        LessonResponseForAdmin response = new LessonResponseForAdmin(lessonID, detailsHorseID, detailsInstructorID, detailsRoute);
//
//        when(lessonsRepository.findById(lessonID)).thenReturn(Optional.of(lesson));
...
//        when(lessonMapping.toResponse(lesson)).thenReturn(response);
//
//        LessonResponseForAdmin result = service.update(lessonID, details);
//
//        assertNotNull(result);
